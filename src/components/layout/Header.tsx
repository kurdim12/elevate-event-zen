...
const navigation: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { name: "Saudi Arabia", href: "/destinations/saudi-arabia", description: "Riyadh, Jeddah, AlUla" },
      { name: "Egypt", href: "/destinations/egypt", description: "Pyramids of Giza, North Coast" },
      { name: "UAE", href: "/destinations/uae", description: "Dubai, Abu Dhabi, Sharjah" },
      { name: "Dubai", href: "/destinations/dubai", description: "Downtown, Palm Jumeirah, Marina" },
      { name: "Doha, Qatar", href: "/destinations/doha", description: "West Bay, The Pearl, Lusail" },
      { name: "Thailand", href: "/destinations/thailand", description: "Bangkok, Pattaya, Phuket" },
      { name: "India", href: "/destinations/india", description: "Mumbai, Delhi, Udaipur, Goa" },
      { name: "Vietnam", href: "/destinations/vietnam", description: "Ho Chi Minh, Hanoi, Da Nang" },
      { name: "China", href: "/destinations/china", description: "Shanghai, Beijing, Shenzhen" },
      { name: "United States", href: "/destinations/usa", description: "NJ, Chicago, TX, CA, Boston, LA" },
      { name: "Canada", href: "/destinations/canada", description: "Toronto, Ottawa, Vancouver" },
    ],
  },
  { name: "Work", href: "/work" },
